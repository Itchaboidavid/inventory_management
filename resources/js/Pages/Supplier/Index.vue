                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex justify-between items-center mb-10">
                            <h3 class="text-lg font-semibold"><i class="fa-solid fa-table"></i> Suppliers Table</h3>

                            <Link :href="route('suppliers.create')">
                            <PrimaryButton>Add New Supplier</PrimaryButton>
                            </Link>
                        ...
                        <table id="suppliersTable" class="display">
                            <thead>
                                <tr>
                                    <th><i class="fa-solid fa-building"></i> &nbsp;Name</th>
                                    <th><i class="fa-solid fa-user"></i> &nbsp;Contact Person</th>
                                    ...
                                    <td>
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                ...
                                                <button type="button" @click="deleteSupplier(supplier.id)"
